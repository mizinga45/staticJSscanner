...
class SSRFRule(VulnerabilityRule):
    """Detects Server-Side Request Forgery (CWE-918, OWASP A10)."""

    def __init__(self):
        super().__init__(
            vuln_type="Server-Side Request Forgery (SSRF)",
            cwe_id="CWE-918",
            description="User input used as URL in server-side HTTP request."
        )
        self.http_funcs = {'fetch', 'get', 'post', 'put', 'request', 'axios', 'http'}
